...
use FosBundle\Form\CategoriesType;
...
class CategoriesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FosBundle:Categories')->findAll();
     ...
     * @Method("POST")
     * @Template("FosBundle:Categories:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FosBundle:Categories')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FosBundle:Categories:edit.html.twig")
     */
